...
export async function generateMetadata() {
	try {
		...
		return {
			title: 'Блог Айкос Илюма — новости, обзоры и советы по IQOS, Terea и Heets',
			description:
				'Полезные статьи о Айкос Илюма, стиках Terea и Heets, вейпах и табаке. Обзоры новинок, советы по выбору, актуальные новости.',
