...
export const metadata = {
  ...
  description:
    "Свяжитесь с нами для заказа Айкос Илюма, стиков Terea и аксессуаров. Консультации и быстрая доставка.",
  alternates: {
  ...
  return (
    <div className="contacts">
      ...
      <div className="adress">
        {/* <h3>Адрес</h3>
        <p>
          г.Москва - ул. Римского-Корсакова, 11, корп. 8 <br></br> Ориентир:
          Пункт "OZON"
        </p> */}
        <p>
