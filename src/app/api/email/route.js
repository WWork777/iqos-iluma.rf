...
export async function POST(req) {
  try {
    ...
    let subject = "Заявка с сайта айкос-алюма.рф";
    ...
    if (text.includes("НОВЫЙ КЛИЕНТ") || text.includes("🔥 НОВЫЙ КЛИЕНТ 🔥")) {
      subject = `🔥 НОВЫЙ КЛИЕНТ: ${customerName} - айкос-алюма.рф`;
    } else {
      subject = `Заявка от ${customerName} - айкос-алюма.рф`;
    }
        ...
        <body>
          <div class="email-container">
            <div class="email-header">
              <h2>Заявка с сайта айкос-алюма.рф</h2>
            </div>
            ...
            <div class="email-content">
              ...
              <div class="footer">
                <p>Отправлено с сайта айкос-алюма.рф</p>
    ...
    const mailOptions = {
      ...
      headers: {
        ...
        "X-Mailer": "айкос-алюма.рф Contact Form",
      },
    };
